...
const SVGCompiler = require('@workato/svg-baker');
const spriteFactory = require('@workato/svg-baker/lib/sprite-factory');
const Sprite = require('@workato/svg-baker/lib/sprite');
